    ...
    <div class="py-12">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <div class="mb-6 grid grid-cols-1 gap-4 md:grid-cols-4">
                <div class="rounded-lg border-l-4 border-blue-500 bg-white p-4 shadow sm:rounded-lg">
                ...
                <div class="rounded-lg border-l-4 border-green-500 bg-white p-4 shadow sm:rounded-lg">
                ...
                <div class="rounded-lg border-l-4 border-yellow-500 bg-white p-4 shadow sm:rounded-lg">
                ...
                <div class="rounded-lg border-l-4 border-red-500 bg-white p-4 shadow sm:rounded-lg">
            ...
            <div class="mb-6 grid grid-cols-1 gap-6 md:grid-cols-3">
                <div
                    class="flex flex-col items-center justify-center rounded-lg bg-white p-6 shadow sm:rounded-lg md:col-span-1">
                    <h3 class="mb-4 text-center text-sm font-bold text-gray-700">Persentase Status Gizi Desa</h3>
